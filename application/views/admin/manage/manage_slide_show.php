<div class="container mr-3">
    ...
    <?php endif ?>
    <br>
    <a type="button" href="<?= base_url() ?>posts_tambah/tambah_slide_show" class="btn btn-outline-primary mb-3"><i class="fas fa-plus"></i> ADD</a>
                ...
                <tr>
                    ...
                    <td scope="row">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="<?= base_url() ?>posts_update/update_slide_show/<?= $post['id_galeri_konten'] ?>">Edit</a>
                            <a class="dropdown-item" href="<?= base_url() ?>posts_hapus/hapus_slide_show/<?= $post['id_galeri_konten'] ?>" onclick="return confirm('apakah anda ingin menghapusnya?')">Delete</a>
                        </div>
                    </td>
