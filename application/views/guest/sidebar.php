    <div class="col-md-4 offset-md-0 new-panel">
        <div id="galery">
            <div>
                <a href="<?= base_url()?>guest/galery_view"><h4 class="nav-style">Galery</h4></a>
            </div>
            ...
            <div style="margin: auto; margin-bottom:1rem;">
                <a href="<?=base_url()?>guest/galery_view" role="button" class="btn my-btn">Foto Lainnya &raquo;</a>
            </div>
        </div>
        <div id="video">
            <div class="new-panel">
                <a href="<?= base_url()?>guest/galery_view"><h4 class="nav-style">Video</h4></a>
            </div>
            ...
            <hr>
            <div style="margin: auto; margin-bottom:1rem;">
                <a href="<?=base_url()?>guest/galery_view" role="button" class="btn my-btn">Video Lainnya &raquo;</a>
            </div>
        </div>
        <div id="agenda">
            <div class="new-panel">
                <a href="<?= base_url()?>guest/agenda_view"><h4 class="nav-style">Agenda</h4></a>
            </div>
            <div class="card new-panel" style="">
                ...
                <hr>
                <div style="margin: auto; margin-bottom:1rem;">
                    <a href="<?=base_url()?>guest/agenda_view" role="button" class="btn my-btn">Agenda Lainnya &raquo;</a>
                </div>
            </div>
        </div>
        <div class="" id="kategori">
            <div class="new-panel">
                <a href="<?= base_url()?>guest/agenda_view"><h4 class="nav-style">Kategori Berita</h4></a>
            </div>
            <div class="card new-panel" style="">
                    <div class="card-body">
                <?php for ($i=0; $i < 25; $i++) {  ?>
